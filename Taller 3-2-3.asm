section .data
    msg_lower db "El número es menor o igual a 10", 0xA   ; Mensaje si es menor o igual a 10
    len_msg_lower equ $ - msg_lower                       ; Longitud del mensaje anterior
    
    msg_greater db "El número es mayor a 10", 0xA         ; Mensaje si es mayor a 10
...
_start:
    ...
    jle lower_than_or_equal   ; Si el número es menor o igual a 10 salta a lower_than
    
    imprimir_mensaje msg_greater, len_msg_greater ; Imprime el mensaje de mayor a 10
    jmp end_if_else           ; Salta al final de la estructura if-else

lower_than_or_equal:

imprimir_mensaje msg_lower, len_msg_lower ; Imprime el mensaje de menor o igual a 10
